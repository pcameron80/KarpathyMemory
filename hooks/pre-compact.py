...
context and spawning flush.py to extract knowledge that would otherwise be
...
def main() -> None:
    ...
    logging.info("PreCompact fired session=%s slug=%s", session_id, rp.slug)
    ...
    context_file = rp.state_dir / f"precompact-{session_id}-{timestamp}.md"
